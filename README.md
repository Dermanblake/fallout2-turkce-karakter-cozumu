...
ÖNEMLİ: Oyun içinden aldığınız ".msg" dosyalarının bazıları notepad++ da ASCII olarak geliyor (notepad++ da sağ altta görünen kısım). Diller kısmından UTF-8'e çevirin. yoksa çeviri yapıp kaydettikten sonra türkçe karakterler siliniyor.
